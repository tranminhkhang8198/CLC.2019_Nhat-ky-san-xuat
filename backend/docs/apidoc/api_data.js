define({ "api": [
  ...
  },
  {
    "type": "post",
    "url": "/api/crop-tasks",
    "title": "Create new task for crop",
    "name": "CreateNewCropTask",
    "group": "CropTasks",
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://localhost:3001/api/crop-tasks",
        "type": "curl"
      }
    ],
    "header": {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "name",
            "description": "<p>Tên công việc, tác vụ</p>"
          },
          {
            "group": "Parameter",
            "type": "Date",
            "optional": false,
            "field": "startDate",
            "description": "<p>Ngày bắt đầu công việc (ISO 8601 format)</p>"
          },
          {
            "group": "Parameter",
            "type": "Date",
            "optional": false,
            "field": "endDate",
            "description": "<p>Ngày kết thúc công việc (ISO 8601 format)</p>"
          },
          {
            "group": "Parameter",
            "type": "ObjectId",
            "optional": false,
            "field": "diaryId",
            "description": "<p>Id nhật ký chung của mùa vụ</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "type",
            "description": "<p>Loại công việc (một trong bốn loại &quot;Bón Phân&quot;, &quot;Phun Thuốc&quot;, &quot;Nước&quot;, &quot;CV khác&quot;)</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "stage",
            "description": "<p>Giai đoạn phát triển</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
        ...
        "Error 4xx": [
          {
            ...
            "optional": false,
            "field": "name-is-required",
            "description": "<p>Trường tên công việc, tác vụ là bắt buộc</p>"
          },
          {
            "group": "Error 4xx",
            "optional": false,
            "field": "diaryId-is-required",
            "description": "<p>Id nhật ký chung của mùa vụ là bắt buộc</p>"
          },
          {
            "group": "Error 4xx",
            "optional": false,
            "field": "diaryId-doesnt-exist",
            "description": "<p>Id nhật ký chung của mùa vụ không tồn tại</p>"
          },
          {
            "group": "Error 4xx",
            "optional": false,
            "field": "type-is-invalid",
            "description": "<p>Loại công việc phải là một trong 4 loại &quot;Bón Phân&quot;, &quot;Phun Thuốc&quot;, &quot;Nước&quot;, &quot;CV khác&quot;</p>"
          },
          {
            "group": "Error 4xx",
            "optional": false,
            "field": "startDate-must-be-ISO-8601-format",
            "description": "<p>Ngày bắt đầu công việc phải thuộc định dạng ISO 8601</p>"
          },
          {
            "group": "Error 4xx",
            "optional": false,
            "field": "endDate-must-be-ISO-8601-format",
            "description": "<p>Ngày kết thúc công việc phải thuộc định dạng ISO 8601</p>"
          }
        ]
      },
      "examples": [
    ...
    "version": "0.0.0",
    "filename": "routes/v1/cropTask.router.js",
    "groupTitle": "CropTasks"
  },
  {
    "type": "post",
    "url": "/api/create-sample-template",
    "title": "Create sample task template for crop",
    "name": "CreateSampleTemplate",
    "group": "CropTasks",
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://localhost:3001/api/create-sample-template",
        "type": "curl"
      }
    ],
    "header": {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "diaryId",
            "description": "<p>Id nhật ký chung của vụ mùa</p>"
          }
        ]
      },
      "examples": [
  ...
  {
    "type": "delete",
    "url": "/api/crop-tasks/:id",
    "title": "Delete task of crop",
    "name": "DeleteCropTask",
    "group": "CropTasks",
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://localhost:3001/api/crop-tasks/5e09757502716412c0b026d7",
        "type": "curl"
      }
    ],
    "header": {
  ...
  },
  {
    "type": "get",
    "url": "/api/crop-tasks",
    "title": "Get all task of crop",
    "name": "GetAllCropTasks",
    "group": "CropTasks",
    "examples": [
      {
        "title": "Get all task of crop with paginating:",
        "content": "curl -i http://localhost:3001/api/crop-tasks?cooperativeId=HTXNN&pageNumber=1&nPerPage=20",
        "type": "curl"
      },
      {
        "title": "Get all task of crop with paginating and specific diary:",
        "content": "curl -i http://localhost:3001/api/crop-tasks?cooperativeId=HTXNN&diaryId=5e75c38c40019a40362038ff&pageNumber=1&nPerPage=20",
        "type": "curl"
      }
    ],
    "header": {
  ...
  },
  {
    "type": "get",
    "url": "/api/crop-tasks/:id",
    "title": "Get task of crop",
    "name": "GetCropTask",
    "group": "CropTasks",
    "examples": [
      {
        "title": "Get crop task:",
        "content": "curl -i http://localhost:3001/api/crop-tasks/5e7713bc31d4d0077efd283d",
        "type": "curl"
      }
    ],
    "header": {
  ...
  },
  {
    "type": "patch",
    "url": "/api/crop-tasks",
    "title": "Update task of crop",
    "name": "UpdateCropTask",
    "group": "CropTasks",
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://localhost:3001/api/crop-tasks/5dedd6f7a4b891348bc0a83d",
        "type": "curl"
      }
    ],
    "header": {
  ...
  {
    "type": "get",
    "url": "/v1/api/diary/:diaryID",
    "title": "Get Diary info by ID",
    "version": "1.0.0",
    "sampleRequest": [
      {
        "url": "http://localhost:3001/v1/api/diary/5e9d5e59c1722f38c42088ea"
      }
    ],
    "name": "GetDiaryByID",
    "group": "Diary",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "result.plantID",
            "description": "<p>Plant unique ID</p>"
          },
          {
            "group": "Success 200",
            "type": "String[]",
            "optional": false,
            "field": "result.fields",
            "description": "<p>List of fields</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
          ...
          },
          {
            ...
            "optional": false,
            "field": "result.begin",
            "description": "<p>Farming begin date</p>"
          },
          {
            "group": "Success 200",
            "type": "Date",
            "optional": false,
            "field": "result.end",
            "description": "<p>Farming end date</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
          ...
          },
          {
            ...
            "description": "<p>Diary description</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
    ...
    "filename": "routes/v1/diary.router.js",
    "groupTitle": "Diary"
  },
  {
    "type": "post",
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:3001/v1/api/diary"
      }
    ],
    "name": "postNewDiary",
    "group": "Diary",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "type": "Object",
            "optional": false,
            "field": "goodsReceiptInfo",
            "description": "<p>Thông tin hoá đơn nhập của sản phẩm được xuất kho</p>"
          },
          {
            "group": "Parameter",
            "type": "Object",
            "optional": false,
            "field": "goodsReceiptInfo.id",
          ...
          },
          {
            ...
            "type": "Object",
            "optional": false,
            "field": "goodsReceiptInfo.quanity",
            "description": "<p>Số lượng xuất kho tương ứng với hoá đơn nhập</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
